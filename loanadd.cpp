 ...
 * @param event
 */
void loanadd::showEvent(QShowEvent *event)
{
 ...
 * @param parent
 */
loanadd::loanadd(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::loanadd),
    m_usersModel(NULL),
 ...
 */
void loanadd::on_radioButtonRooms_clicked()
{
 ...
 */
void loanadd::on_radioButtonResources_clicked()
{
 ...
 */
void loanadd::on_lineEditUserSearch_textChanged(const QString & arg1)
{
    if(!dbcon::connecttodb())
        return;
 ...
 */
void loanadd::on_buttonClearUserSearch_clicked()
{
 ...
 */
void loanadd::on_buttonSubmitLoanEditingroom_clicked()
{
    /*
...
void loanadd::on_lineEditSearchText_textChanged(const QString &arg1)
{
    if(!dbcon::connecttodb())
        return;
...
void loanadd::on_buttonAdd_clicked()
{
...
void loanadd::on_buttonDelLoanPosition_clicked()
{
...
void loanadd::on_buttonDelAllLoanPositions_clicked()
{
    ui->tableWidgetDesiredItems->clearResourcesList();
...
void loanadd::on_buttonSubmitLoanResources_clicked()
{
    if(ui->tableWidgetDesiredItems->rowCount() == 0)
    {
...
void loanadd::on_tableWidgetDesiredItems_itemChanged(QTableWidgetItem *item)
{
...
void loanadd::on_tableViewResources_doubleClicked(const QModelIndex &)
{
    this->on_buttonAdd_clicked();
}

void loanadd::on_buttonClearSearchText_clicked()
{
    ui->lineEditSearchText->clear();
}
