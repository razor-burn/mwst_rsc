...
public:
    explicit loanmgmt(QWidget *parent = 0);
    ~loanmgmt();
    void init();
    int setInactive();
...
private slots:
    ...
    void on_buttonEditLoanPushed(QModelIndex id);
    void on_buttonEditRoomLoanPushed(QModelIndex id);
